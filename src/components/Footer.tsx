...
export default function Footer() {
  return (
    <footer className="bg-isclub-navy text-white py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-5 gap-8">
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/kusomISC" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-isclub-teal transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                </svg>
              </a>
              <a href="https://www.instagram.com/kusomisc/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-isclub-teal transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  Block 10, Kathmandu University<br />
                  Dhulikhel, Kavre<br />
                  Nepal
                </span>
              </li>
              <li className="flex items-center">
                ...
                <a href="tel:+9779840037381" className="text-gray-400 hover:text-isclub-teal transition-colors">
                  +977 9840037381
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 text-isclub-teal mr-3 flex-shrink-0" />
                <a href="mailto:informationsystemclub@kusom.edu.np" className="text-gray-400 hover:text-isclub-teal transition-colors">
            ...
            <div className="overflow-hidden rounded-lg">
              <div style={{ height: '200px', width: '100%', maxWidth: '100%' }}>
                <iframe
                  ...
                  frameBorder="0"
                  src="https://www.google.com/maps/embed/v1/place?q=department+of+management+informatics+and+communication&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                  allowFullScreen
                ></iframe>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
          <p>Designed and developed by Technical Team of IS Club 2025</p>
        </div>
      </div>
    </footer>
  );
